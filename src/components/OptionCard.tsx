...
export const OptionCard = ({ title, description, icon: Icon, onClick, className }: OptionCardProps) => {
  return (
    <button
      onClick={onClick}
      className={cn(
        "group relative bg-gradient-to-br from-card to-card/80 rounded-xl p-4 md:p-6",
    ...
    >
      <div className="space-y-2 md:space-y-3">
        {/* Icon */}
        <div className="inline-flex items-center justify-center w-10 h-10 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-primary/20 to-primary/10 group-hover:from-primary/30 group-hover:to-primary/20 transition-all duration-300">
